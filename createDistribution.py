...
includes = ['__init__','cboe','csvDatabase','functions','yahooFinance','extra','bats','backtest','plotting','calendar']
...
shutil.copyfile('lib/data/vix_expiration.txt',os.path.join(DEST,'lib/data/vix_expiration.txt'))
